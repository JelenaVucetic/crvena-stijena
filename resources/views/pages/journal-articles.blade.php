                        ...
                        <div class="news-block">
                            <div class="inner-box">
                                <div class="lower-content">
                                    <p>{{ __('journal-articles-paragraph-one') }}</p>
                                    <p>{{ __('journal-articles-paragraph-two') }}</p>
                                    <p>{{ __('journal-articles-paragraph-three') }}</p>
                                    <p>{{ __('journal-articles-paragraph-for') }}</p>
                                    <p>{{ __('journal-articles-paragraph-five') }}</p>
                                    <p>{{ __('journal-articles-paragraph-six') }}</p>
                                    <p>{{ __('journal-articles-paragraph-seven') }}</p>
                                    <p>{{ __('journal-articles-paragraph-eight') }}</p>
                                    <p>{{ __('journal-articles-paragraph-nine') }}</p>
